-- Haskell este static type == stim toate 
...
-- Floating -- Clasa numerelor reale, fromIntegral - transforma un numar intreb 
-- intr-un numar real
-- ==============================
-- ==============================
-- Create Tipurilor
...
data Vector a = Vect2 a a | Vect3 a a a deriving (Show)
...
instance (Show a) => Show (Tree a) where
    show = ppShow 0 where
        ...
        ppShow n (Node v l r) = printSpace n ++ (show v) ++ "\n" ++
                                (ppShow (n+4) l) ++ (ppShow(n+4) r)
